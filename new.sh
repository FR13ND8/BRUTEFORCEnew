...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" failod28 [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" failod28"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.failod28] [MR.B]"$i"  |"
...
echo $ku"Facebook :"$i"failod28@gmail.com"
sleep 2
